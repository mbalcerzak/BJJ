athlete_dictionary = {
	...
	'Antônio Rodrigo Nogueira "Minotauro"':['antonio rodrigo nogueira', 'nogueira'],
	...
	'Clark Gracie':['clark gracie', 'clark'],
	...
	'Demian Maia':['demian maia', 'damien maia', 'maia', 'damian miai'],
	...
	'Eduardo Telles':['eduardo telles', 'telles'],
	...
	'Garry Tonon':['garry tonon', 'tonon', 'gary tonon', 'garry tonnen', 'gray tonnin', 'tonner', 'garry'],
	...
	'Jeff Monson':['jeff monson', 'monson'],
	'Jeff Shaw':['jeff shaw'],
	...
	'Keenan Cornelius':['keenan cornelious', 'keenan', 'cornelius', 'kennnan kornelius', 'kennen cornelius'],
	...
	'Kurt Osiander':['kurt osiander', 'ocieander', 'oisander', 'kurt ocieander', 'kurt'],
	'Lachlan Giles':['lachlan giles'],
	'Leandro Lo':['leandro lo', 'lo'],
	...
	'Luiz Fux':['luiz fux'],
	'Luiz Heredia':['luiz heredia'],
	'Luiz Palhares':['luiz palhares'],
	'Luiza Monteiro':['luiza monteiro'],
	'Leonardo Alcantara Vieira':['léo vieira', 'leandro vieira'],
	'Mackenzie Dern':['mackenzie dern', 'mckenzie dern', 'meckenzie dern', 'makinzie dern', 'dern'],
	'Mansher Khera':['mansher khera'],
	...
	'Marcus "Buchecha" Almeida':['marcus "buchecha" almeida', 'marcus buchecha almeida', 'marcus buchecha', 'marcus buchecha abreu'],
	...
	'Miyao Brothers':['miao bros', 'miyao', 'miyao brothers', 'the miyaos', 'miyao twins'],
	'Michael Langhi':['michael langhi'],
	'Micheal Liera':['micheal leria', 'liera jr'],
	'Michelle Nicollini':['michelle nicolini', 'nicolini'],
	'Mickey Gall':['mickey gall'],
	'Milton Vieira':['milton vieira'],
	'Mr. Miyagi':['miyagi'],
	'Moises Muradi':['moises muradi'],
	'Murilo Bustamante':['murilo bustamante', 'murillo b'],
	...
	'Nick Diaz':['nick diaz'],
	'Antonio "Nino" Schembri':['nino', 'nino schembri'],
	'Oliver "Oli" Geddes':['oli'],
	...
	'Percy Harvin':['percy harvin'],
	'Rafael Lovato Jr.':['rafael lovato jr.', 'rafael lovato', 'lovato', 'lovato jr'],
	'Rafael Mendes':['rafael mendes', 'rafa mendes', 'rafa'],
	'Ralph Gracie':['ralph'],
	'Daniel "Raspberry Ape" Strauss':['raspberry ape', 'daniel strauss'],
	'Relson Gracie':['relson gracie'],
	'Renato Paquet':['renato paquet'],
	'Rener Gracie':['rener gracie'],
	'Renzo Gracie':['renzo gracie', 'renzo'],
	...
	'Roberto "Cyborg" Abreu':['roberto "cyborg" abreu', 'cyborg', 'robert cyborg abreu', 'cyborg abreu'],
	...
	'Rodoflo Viera':['rodoflo viera', 'rodolfo vieira', 'rodolpho', 'rodolfo', 'viera', 'rodalfo vierrea', 'rodolpho viera'],
	...
	'Romulo Barral':['romulo barral', 'romulo'],
	...
	'Wellington "Megaton" Dias':['wellington "megaton" dias', 'megaton', 'megaton dias'],
