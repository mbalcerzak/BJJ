...
'  i can find.'
'  on fight pass.'
'  on . professional mma matches if that counts.'
'  that goes on .'
'  that i can find.'
'aoki'
'arrrrr slash bjj'
...
'but not digging . i  ebi on ufc fight pass'
...
'ebi  metaoirs'
'ebi   on the computer.'
'ebi      use to  metamoros until scandals broke'
'ebi  some '
'ebi '
'ebi highlights from various comps'
'ebi  worlds'
'ebi is my favourite but i also    '
'ebi   other stuff after on . ill be ing more  events in the future.'
'ebi meta  copa'
'ebi '
'ebi  '
'ebi  '
...
'ebi   flo'
'ebi mostly'
'ebi mostly  the random match on the internet. i also attended worlds 2015 as a spectator.'
'ebi mostly.'
'ebi occasionally. more disinterested as time goes on.'
'ebi on fight pass'
'ebi on  '
'ebi on '
'ebi '
...
'ebi  before'
'ebi / worlds '
'ebi ufc fight pass  not sure where i ed it last'
'ebi  replays on ufc fight pass'
'ebi.'
'ebi. . worlds adcv.   on .  you tube'
'ebis'
'edi  worlds'
'eduardo telles'
'edwin najmi'
...
'everything available at  ebi  copa podio'
...
'i think...'
'i try to support uk events but i also  ebi   occasionally'
'i try to  as mevents as possible like '
'i   do free streams stream it with purchase with training partners'
'i  all of them'
'i  all streams from . i paid for ebi'
'i  almost all the  events through '
...
'i  ebi'
'i  ebi   until it went all weirdo  stopped paying people. normally we  at someones house.'
'i  every kind of bjj fights i can get on the internet .  mundials ebi  copa podium etc'
...
' tv'
' worlds'
' worlds europeans  sometimes  ebi i dont like to  females compete.'
' worlds. i dont pay for it though because im poor. if i could i would.'
'id rather just read news. i dont need a chat narrator to tell me about it.'
'if i see a guest im interested in'
'if that counts'
'if that counts.'
'ignore it.'
...
'ive never ed a whole event'
'ive ordered   i    the worlds.'
'ive ed for  once.'
'ive seen   . most viewing is of  on .'
'ive ed  in the past'
'j.j. machado'
'jacar'
'jacare'
...
'just joe  experience'
'just on '
'just seen clips on    other places.'
'just '
'just videos on '
'just  other  videos that comes across social media. rarely'
'just  videos of whatever.'
'kazushi sakuraba'
'keenan c.'
...
'paulo miyao'
'pedro sauer'
'popular no gi organisations. '
'position impossible'
'powerful jre covers mtopics including grappling'
'.  streams of friends in various super fights'
'/  ive ed ebi'
's   streams i.e. annual subscription to    major  worlds'
's like ebi'
...
'xande/saulo ribeiro'
'xhamster.com'
'yeah  i  all except ebi cause that stuff gets kinda lame. i like the kron gracie match rodolfo viera  so on people who do good jiu jitsu'
'yoga for bjj'
